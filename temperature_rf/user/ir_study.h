...
#define EEP_IR_OFS_POW  (g_dev.mode.power * NUM_MODE * NUM_FAN * NUM_TEMP)
#define EEP_IR_OFS_MOD  (g_dev.mode.mod   * NUM_FAN * NUM_TEMP)
#define EEP_IR_OFS_WID  ((g_dev.mode.wind - 1)  * NUM_TEMP) // default wind is Min = 1, not close
