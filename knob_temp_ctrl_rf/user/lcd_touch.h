...
#define LCD_RAM_USED    6

#define SEG_T1_ON   lcd_ram[4] |=  (1 << 24)
#define SEG_T1_OF   lcd_ram[4] &= ~(1 << 24)

#define SEG_T2_ON   lcd_ram[4] |=  (1 << 25)
#define SEG_T2_OF   lcd_ram[4] &= ~(1 << 25)

#define SEG_T3_ON   lcd_ram[4] |=  (1 << 26)
#define SEG_T3_OF   lcd_ram[4] &= ~(1 << 26)

#define SEG_T4_ON   lcd_ram[4] |=  (1 << 27)
#define SEG_T4_OF   lcd_ram[4] &= ~(1 << 27)

#define SEG_T5_ON   lcd_ram[0] |=  (1 << 3)
#define SEG_T5_OF   lcd_ram[0] &= ~(1 << 3)

#define SEG_T6_ON   lcd_ram[0] |=  (1 << 2)
#define SEG_T6_OF   lcd_ram[0] &= ~(1 << 2)

#define SEG_T7_ON   lcd_ram[0] |=  (1 << 1)
#define SEG_T7_OF   lcd_ram[0] &= ~(1 << 1)

#define SEG_T8_ON   lcd_ram[0] |=  (1 << 0)
#define SEG_T8_OF   lcd_ram[0] &= ~(1 << 0)

#define SEG_T9_ON    lcd_ram[0] |=  (1 << 9)
#define SEG_T9_OF    lcd_ram[0] &= ~(1 << 9)

#define SEG_T10_ON   lcd_ram[0] |=  (1 << 10)
#define SEG_T10_OF   lcd_ram[0] &= ~(1 << 10)

#define SEG_T11_ON   lcd_ram[0] |=  (1 << 11)
#define SEG_T11_OF   lcd_ram[0] &= ~(1 << 11)

#define SEG_T12_ON   lcd_ram[0] |=  (1 << 16)
#define SEG_T12_OF   lcd_ram[0] &= ~(1 << 16)

#define SEG_T13_ON   lcd_ram[2] |=  (1 << 16)
#define SEG_T13_OF   lcd_ram[2] &= ~(1 << 16)

#define SEG_T14_ON   lcd_ram[3] |=  (1 << 8)
#define SEG_T14_OF   lcd_ram[3] &= ~(1 << 8)

#define SEG_T15_ON   lcd_ram[1] |=  (1 << 0)
#define SEG_T15_OF   lcd_ram[1] &= ~(1 << 0)

#define SEG_T16_ON   lcd_ram[3] |=  (1 << 9)
#define SEG_T16_OF   lcd_ram[3] &= ~(1 << 9)

#define SEG_T17_ON   lcd_ram[3] |=  (1 << 27)
#define SEG_T17_OF   lcd_ram[3] &= ~(1 << 27)

#define SEG_T18_ON   lcd_ram[3] |=  (1 << 10)
#define SEG_T18_OF   lcd_ram[3] &= ~(1 << 10)

#define SEG_T19_ON   lcd_ram[3] |=  (1 << 11)
#define SEG_T19_OF   lcd_ram[3] &= ~(1 << 11)

#define SEG_POINT_SET_ON     lcd_ram[2] |=  (1 << 16)
#define SEG_POINT_SET_OF     lcd_ram[2] &= ~(1 << 16)

#define SEG_POINT_ROOM_ON    lcd_ram[3] |=  (1 << 27)
#define SEG_POINT_ROOM_OF    lcd_ram[3] &= ~(1 << 27)
...
#define DIGIT_POINT_SET_SHOW    SEG_T13_ON
#define DIGIT_POINT_SET_HIDE    SEG_T13_OF

#define DIGIT_POINT_ROOM_SHOW   SEG_T17_ON
#define DIGIT_POINT_ROOM_HIDE   SEG_T17_OF

#define SHOW_DIGIT_POINT     DIGIT_POINT_ROOM_SHOW
#define HIDE_DIGIT_POINT     DIGIT_POINT_ROOM_HIDE

#define SHOW_DIGIT_MINUS     lcd_ram[5] |= SEG_MINUS(3)
