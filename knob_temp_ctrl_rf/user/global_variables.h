...
#define KEY_INDEX_FUNC   2
#define KEY_INDEX_PWR    3
#define KEY_INDEX_UP     4
#define KEY_INDEX_DOWN   5


#define LCD_FUNC_DELAY_TIME    20    // 20 * 100ms = 2s

#define TIMING_TASK_MAX        48
...
typedef enum _pipe_type_t_ {
    PIPE_ERR   = 0x00,
    PIPE_DOUB  = 0x02,
    PIPE_QUAD  = 0x04
} pipe_type_t;

typedef enum _zigbee_ctrl_t_ {
    ZIG_REG = 0x00,
    ZIG_CLR = 0x01
} zigbee_ctrl_t;
...
extern volatile dev_type_t g_dev_type;
...
extern volatile clr_type g_erasing_index;
...
extern uint16_t g_lcd_delay;
extern uint8_t g_led_on;
extern uint16_t g_led_delay;
...
extern lcd_func g_lcd_func;
extern volatile uint16_t g_lcd_func_delay;
extern volatile knob_direction g_knob_direction;
extern volatile uint8_t g_knob_counter;
extern volatile uint8_t g_knob_changed;
extern volatile uint8_t g_timing_task;
extern volatile uint16_t g_counter_sec;
extern volatile uint16_t g_counter_min;
extern volatile uint8_t g_fan_ultralow;
extern volatile zigbee_ctrl_t g_zig_ctrl;
...
#if TEMP_CTRL_KNOB
#define BUTTON_FUNC     g_btn[2]
#define BUTTON_PWR      g_btn[3]
#elif TEMP_CTRL_TOUCH
#define BUTTON_UP       g_btn[2]
#define BUTTON_DOWN     g_btn[3]
#define BUTTON_PWR      g_btn[4]
#endif
