...
/******************************************************************************
                            1:修改产品信息
******************************************************************************/
#define PRODUCT_KEY "tij5ii4a"    //开发平台创建产品后生成的16位字符产品唯一标识
...
/******************************************************************************
                    ...
                    如当前使用MCU的RAM不够,可修改
******************************************************************************/
#define ZIGBEE_UART_QUEUE_LMT             128//16         //数据接收队列大小,如MCU的RAM不够,可缩小
#define ZIGBEE_UART_RECV_BUF_LMT          64              //根据用户DP数据大小量定,必须大于24
#define ZIGBEE_UART_SEND_BUF_LMT          64              //根据用户DP数据大小量定,必须大于24
